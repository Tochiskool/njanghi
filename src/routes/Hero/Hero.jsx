...
const careers = ["I am a Programmer","A Software engineer","A Web Developer", "And am still studying hard"]
let careerIndex = 0;
    let charIndex = 0;
const Hero = () => {
  const [display, setDisplay] = useState("none");
  const [animateNow, setAnimateNow] = useState(`${careers[careerIndex].slice(0)}`)
  ...
  return (
    <>
             <header className="header-primary">
                ...
                <div onClick={handleDisplay} className='btn display btn-primary btn-toggle-menu'>
                ...
                <img src={imageHero} />
                  <div className="container">
                      <div className="hero-body">
                          ...
                          <h4 onClick={handleAnimation}  className="hero-subtitle">{animateNow}</h4>
